...
for i in range(10):
    rr = load_data(f'../data/public_data/bert-EfficientGlobalPointer-32-2e-05-pgd-kf{i}-test-b.txt')
    # print(rr)
    print(i, rr[100])
    all_res.append(rr)
...
fw = open('data/public_data/vote_testb_pseudo_tag420.txt', 'w', encoding='utf-8')
res_n = {}
